...
SELECT
    ...
    SUM(values_averageclass_co2withoutrfiperpassengerintons * emissionflightinfo_passengerloadfactor / (emissionflightinfo_passengerloadfactor + 0.01) * frequency * emissionflightinfo_passengerloadfactor * seatcount) AS co2_p1,
    SUM(values_averageclass_co2withoutrfiperpassengerintons * emissionflightinfo_passengerloadfactor / (emissionflightinfo_passengerloadfactor + 0.05) * frequency * emissionflightinfo_passengerloadfactor * seatcount) AS co2_p5,
    SUM(values_averageclass_co2withoutrfiperpassengerintons * emissionflightinfo_passengerloadfactor / (emissionflightinfo_passengerloadfactor + 0.10) * frequency * emissionflightinfo_passengerloadfactor * seatcount) AS co2_p10,
    ...
    SUM(values_averageclass_co2withoutrfiperpassengerintons * emissionflightinfo_passengerloadfactor / (emissionflightinfo_passengerloadfactor + 0.01) * frequency * emissionflightinfo_passengerloadfactor * seatcount) /
    ...
    SUM(values_averageclass_co2withoutrfiperpassengerintons * emissionflightinfo_passengerloadfactor / (emissionflightinfo_passengerloadfactor + 0.05) * frequency * emissionflightinfo_passengerloadfactor * seatcount) /
    ...
    SUM(values_averageclass_co2withoutrfiperpassengerintons * emissionflightinfo_passengerloadfactor / (emissionflightinfo_passengerloadfactor + 0.10) * frequency * emissionflightinfo_passengerloadfactor * seatcount) /
